...
const testimonials = [
  {
    ...
    company: "Techstars",
    content:
      "...groundbreaking products and solutions poised to address some of the globe's most urgent challenges, including energy stability, supply chain and logistics safety, and sustainability.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Niterra",
    content:
      "Your dedication to understanding industry needs and innovating in real-time tracking and predictive analytics aligns perfectly with our mission. Together, we’re empowering industries to drive optimization and decarbonization.",
    categories: [1, 2, 4],
  },
  {
    ...
    name: "Melanie M.",
    company: "WLGA LPG World",
    content:
      "Our review committee was impressed with TMA and the potential it has for the global LPG industry.",
    categories: [1, 2, 5],
  },
  {
  ...
  },
  {
    ...
    content:
      "A startup lead by an incredible founder, with a drive for excellence and execution.",
    categories: [1, 3, 5],
  },
  {
  ...
  },
  {
    ...
    company: "Fore Conif.",
    content:
      "We are beyond excited to partner with TMA and propel EUropean lead innovation beyond borders and throughout Asia.",
    categories: [1, 4],
  },
  {
    ...
    name: "Jessica A.",
    company: "Braid Theory",
    content:
      "TMA is the subject matter expertise for the circulation, distribution, and rotation of the hazardous goods inventory and bringing their Atex-compliant ML IoT device and platform to market.",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            ...
            build more efficient and sustainable operations anywhere in the world.
          </p>
        </div>
